                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="firstName" id="firstName" value="" placeholder="Enter First Name" value="<?php echo e(old('first_name')); ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="lastName" class="form-label">Last Name</label>
                            <input class="form-control" type="text" name="lastName" id="lastName" value="" placeholder="Enter Last Name" value="<?php echo e(old('last_name')); ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input class="form-control" type="text" name="email" id="email" value="" placeholder="Enter Email" value="<?php echo e(old('email')); ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="age" class="form-label">Age</label>
                            <input class="form-control" type="text" name="age" id="age" value="" placeholder="Enter Age" value="<?php echo e(old('age')); ?>">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
...
<?php /**PATH C:\Users\andre\Kuliah\Semester 3\P App Web\Laravel\modul-12\resources\views/employee/create.blade.php ENDPATH**/ ?>